...
import { tendermint } from "./tendermint/abci/types";
        ...
        export class TxResponse {
          static encode(message: TxResponse, writer: Writer): void {
            ...
            for (let i = 0; i < logs.length; ++i) {
              writer.uint32(58);
              writer.fork();
              cosmos.base.abci.v1beta1.ABCIMessageLog.encode(logs[i], writer);
              writer.ldelim();
            }
          ...
          static decode(reader: Reader, length: i32): TxResponse {
            ...
            while (reader.ptr < end) {
              ...
              switch (tag >>> 3) {
                ...
                case 7:
                  message.logs.push(
                    cosmos.base.abci.v1beta1.ABCIMessageLog.decode(
                      reader,
                      reader.uint32()
                    )
                  );
                ...
                case 11:
                  message.tx = google.protobuf.Any.decode(
                    reader,
                    reader.uint32()
                  );
                  break;
          ...
          data: string;
          raw_log: string;
          logs: Array<cosmos.base.abci.v1beta1.ABCIMessageLog>;
          info: string;
          gas_wanted: i64;
          gas_used: i64;
        ...
        export class ABCIMessageLog {
          static encode(message: ABCIMessageLog, writer: Writer): void {
            ...
            for (let i = 0; i < events.length; ++i) {
              writer.uint32(26);
              writer.fork();
              cosmos.base.abci.v1beta1.StringEvent.encode(events[i], writer);
              writer.ldelim();
            }
          }
          ...
          static decode(reader: Reader, length: i32): ABCIMessageLog {
            ...
            while (reader.ptr < end) {
              ...
              switch (tag >>> 3) {
                ...
                case 3:
                  message.events.push(
                    cosmos.base.abci.v1beta1.StringEvent.decode(
                      reader,
                      reader.uint32()
                    )
                  );
          ...
          msg_index: u32;
          log: string;
          events: Array<cosmos.base.abci.v1beta1.StringEvent>;
        ...
        export class StringEvent {
          static encode(message: StringEvent, writer: Writer): void {
            ...
            for (let i = 0; i < attributes.length; ++i) {
              writer.uint32(18);
              writer.fork();
              cosmos.base.abci.v1beta1.Attribute.encode(attributes[i], writer);
              writer.ldelim();
            }
          }
              ...
              switch (tag >>> 3) {
                ...
                case 2:
                  message.attributes.push(
                    cosmos.base.abci.v1beta1.Attribute.decode(
                      reader,
                      reader.uint32()
                    )
                  );
          ...
          type: string;
          attributes: Array<cosmos.base.abci.v1beta1.Attribute>;
        ...
        export class SimulationResponse {
          static encode(message: SimulationResponse, writer: Writer): void {
            ...
            if (gas_info !== null) {
              writer.uint32(10);
              writer.fork();
              cosmos.base.abci.v1beta1.GasInfo.encode(gas_info, writer);
              writer.ldelim();
            }
            ...
            if (result !== null) {
              writer.uint32(18);
              writer.fork();
              cosmos.base.abci.v1beta1.Result.encode(result, writer);
              writer.ldelim();
            }
          }
          ...
          gas_info: cosmos.base.abci.v1beta1.GasInfo | null;
          result: cosmos.base.abci.v1beta1.Result | null;

          constructor(
            gas_info: cosmos.base.abci.v1beta1.GasInfo | null = null,
            result: cosmos.base.abci.v1beta1.Result | null = null
          ) {
        ...
        export class TxMsgData {
          static encode(message: TxMsgData, writer: Writer): void {
            ...
            for (let i = 0; i < data.length; ++i) {
              writer.uint32(10);
              writer.fork();
              cosmos.base.abci.v1beta1.MsgData.encode(data[i], writer);
              writer.ldelim();
            }
          }
          ...
          static decode(reader: Reader, length: i32): TxMsgData {
            ...
            while (reader.ptr < end) {
              ...
              switch (tag >>> 3) {
                case 1:
                  message.data.push(
                    cosmos.base.abci.v1beta1.MsgData.decode(
                      reader,
                      reader.uint32()
                    )
                  );
          ...
          data: Array<cosmos.base.abci.v1beta1.MsgData>;

          constructor(data: Array<cosmos.base.abci.v1beta1.MsgData> = []) {
            this.data = data;
          }
        }
        ...
        export class SearchTxsResult {
          static encode(message: SearchTxsResult, writer: Writer): void {
            ...
            for (let i = 0; i < txs.length; ++i) {
              writer.uint32(50);
              writer.fork();
              cosmos.base.abci.v1beta1.TxResponse.encode(txs[i], writer);
              writer.ldelim();
            }
          }
          ...
          page_total: u64;
          limit: u64;
          txs: Array<cosmos.base.abci.v1beta1.TxResponse>;
