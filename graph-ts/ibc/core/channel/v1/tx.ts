...
import { ibc } from "./ibc/core/channel/v1/channel";
        ...
        export class MsgChannelOpenInit {
          static encode(message: MsgChannelOpenInit, writer: Writer): void {
            ...
            if (channel !== null) {
              writer.uint32(18);
              writer.fork();
              ibc.core.channel.v1.Channel.encode(channel, writer);
              writer.ldelim();
            }
          ...
          static decode(reader: Reader, length: i32): MsgChannelOpenInit {
            ...
            while (reader.ptr < end) {
              ...
              switch (tag >>> 3) {
                ...
                case 2:
                  message.channel = ibc.core.channel.v1.Channel.decode(
                    reader,
                    reader.uint32()
                  );
                  break;
          ...
          port_id: string;
          channel: ibc.core.channel.v1.Channel | null;
          signer: string;

          constructor(
            port_id: string = "",
            channel: ibc.core.channel.v1.Channel | null = null,
            signer: string = ""
          ) {
        ...
        export class MsgRecvPacket {
          static encode(message: MsgRecvPacket, writer: Writer): void {
            ...
            if (packet !== null) {
              writer.uint32(10);
              writer.fork();
              ibc.core.channel.v1.Packet.encode(packet, writer);
              writer.ldelim();
            }
          ...
          static decode(reader: Reader, length: i32): MsgRecvPacket {
            ...
            while (reader.ptr < end) {
              ...
              switch (tag >>> 3) {
                case 1:
                  message.packet = ibc.core.channel.v1.Packet.decode(
                    reader,
                    reader.uint32()
                  );
                  break;
          ...
          packet: ibc.core.channel.v1.Packet | null;
          proof_commitment: Uint8Array;
          proof_height: ibc.core.client.v1.Height | null;
          signer: string;

          constructor(
            packet: ibc.core.channel.v1.Packet | null = null,
