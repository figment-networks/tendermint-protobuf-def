...
var file_codec_proto_rawDesc = []byte{
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x05, 0x52, 0x05, 0x6e, 0x61, 0x6e, 0x6f, 0x73, 0x22, 0x84, 0x01,
	...
	0x20, 0x01, 0x28, 0x0c, 0x52, 0x02, 0x74, 0x78, 0x12, 0x3a, 0x0a, 0x06, 0x72, 0x65, 0x73, 0x75,
...
var file_codec_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_codec_proto_goTypes = []interface{}{
	...
	(*Timestamp)(nil),                 // 7: fig.tm.codec.v1.Timestamp
	(*TxResult)(nil),                  // 8: fig.tm.codec.v1.TxResult
	(*types.Block)(nil),               // 9: tendermint.types.Block
	(*types.BlockID)(nil),             // 10: tendermint.types.BlockID
	(*types1.ResponseBeginBlock)(nil), // 11: tendermint.abci.ResponseBeginBlock
	(*types1.ResponseEndBlock)(nil),   // 12: tendermint.abci.ResponseEndBlock
	(*types.Validator)(nil),           // 13: tendermint.types.Validator
	(*types1.ResponseDeliverTx)(nil),  // 14: tendermint.abci.ResponseDeliverTx
}
var file_codec_proto_depIdxs = []int32{
	...
	9,  // 6: fig.tm.codec.v1.EventBlock.block:type_name -> tendermint.types.Block
	10, // 7: fig.tm.codec.v1.EventBlock.block_id:type_name -> tendermint.types.BlockID
	11, // 8: fig.tm.codec.v1.EventBlock.result_begin_block:type_name -> tendermint.abci.ResponseBeginBlock
	12, // 9: fig.tm.codec.v1.EventBlock.result_end_block:type_name -> tendermint.abci.ResponseEndBlock
	8,  // 10: fig.tm.codec.v1.EventTx.tx_result:type_name -> fig.tm.codec.v1.TxResult
	13, // 11: fig.tm.codec.v1.EventValidatorSetUpdates.validator_updates:type_name -> tendermint.types.Validator
	14, // 12: fig.tm.codec.v1.TxResult.result:type_name -> tendermint.abci.ResponseDeliverTx
